			...
			<div class="col-md-6">
				...
				<table class="table table-hover">
					<tbody>
						...
						<tr>
							<th>PRICE</th>
							<td>Rs.<del>${productDetail.product_price}</del>
							
							 <mark>Rs.
							<fmt:formatNumber  type="number" maxFractionDigits="2" value="${(productDetail.product_price) - (productDetail.product_price * productDetail.product_discount / 100)}"></fmt:formatNumber></mark>	
						</td>
						</tr>
						<tr>
							<th>DISCOUNT</th>
