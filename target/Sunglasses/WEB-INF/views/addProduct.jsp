			...
			<div class="row">
						...
						<c:otherwise>
							<div class="form-group">
								<form:select path="brand.brand_id" class="form-control" required="true" autofocus="true">
									...
									<form:options class="form-control" items="${brandList}"
										itemValue="brand_id" itemLabel="brand_name" />
								</form:select>
							</div>
						</c:otherwise>
					</c:choose>
				...
				<div class="col-xs-6 col-md-6 form-group">
					<c:choose>
						<c:when test="${productAttribute.product_id != 0 }">
							<div class="form-group">
								<form:select path="category.cat_id" class="form-control" required="true">
